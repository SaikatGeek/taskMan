                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">TaskManager</a></li>
        ...
        <script >
            $(document).ready(function(){
              ...
              function getNotifications(){ 
                ...
                $.ajax({
                    type:'GET',
                    url:"{{ url('ajax/notifications/total') }}",
                    success:function(data){

                        if (data.TotalNotification != 0) {
                            $('#NotificationNumbers').show();
                            if (data.TotalNotification < 100) {
                                $("#NotificationBell").addClass("blink_me");
                                $('#NotificationNumbers').html(data.TotalNotification);
                            }

                            else if(data.TotalNotification > 100){
                                $("#NotificationBell").addClass("blink_me");
                                $('#NotificationNumbers').html('99+');

                            }
                        }
                        else{
                            $('#NotificationNumbers').hide();
                            $("#NotificationBell").removeClass("blink_me");
                        }
